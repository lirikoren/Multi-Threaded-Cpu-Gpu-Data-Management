...
//    boolean IsBroadcastSubscribe(Broadcast type,MicroService microService);
//    /**
...
//    /**
//     * @return true if was signed
//     */

//    boolean IsFutureCompleted(Event event);
//    boolean IsBroadcastRecived(Broadcast type);
//    boolean wasRegister(MicroService microService);
//    boolean wasUnregister(MicroService microService);
//    boolean wasRecivedMessege(MicroService microService);
